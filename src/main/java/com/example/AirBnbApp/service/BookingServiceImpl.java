...
public class BookingServiceImpl implements BookingService {
    ...
    private final CheckoutService checkoutService;  // add this
    ...
    public BookingDto initialiseBooking(BookingRequest bookingRequest) {
        log.info("Initialize booking for hotel:{}, room:{}, date {}-{}",
        ...
        Booking booking = Booking.builder()
                ...
                .amount(BigDecimal.TEN) // TODO: calculate actual price
                .build();
